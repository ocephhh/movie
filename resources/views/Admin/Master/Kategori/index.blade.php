                                ...
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route("admin.master.kategori.edit",$row->id) }}" title="Edit">
                                                <i class="glyphicon glyphicon-pencil" style="color:green"></i>
                                            </a> &nbsp;&nbsp;
                                            <a href="{{ route("admin.master.kategori.delete",$row->id) }}" title="Hapus" class="hapus">
            ...
            $(".datatable").DataTable({
                ...
                buttons: [
                {
                    ...
                    action: function (e, dt, node, config){
                        window.location.href = "{{ route("admin.master.kategori.create") }}";
                    }
                }
                ],
            });
